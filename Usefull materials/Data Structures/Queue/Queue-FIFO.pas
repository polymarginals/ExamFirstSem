...
begin
  ...
  begin
    writeln('ќ«Ґ¬Ґ*в б ЁбЄ®¬л¬ §**зҐ*ЁҐ¬ ' ,znach1, ' ®вбгвбвўгҐв ў ®зҐаҐ¤Ё.');
    exit;
  end;
...
begin
  ...
  begin
    Writeln('ќ«Ґ¬Ґ*в* б Ї®ап¤Є®ўл¬ *®¬Ґа®¬ ' ,posi, ' *Ґв ў ®зҐаҐ¤Ё.');
    writeln('‚ ®зҐаҐ¤Ё ' ,i-1, ' н«Ґ¬Ґ*в®ў(*).');
    exit
  end;
...
begin
  ...
  repeat {цикл для нашего меню}
    ...
    Writeln('Џа®Ја*¬¬* ¤«п а*Ў®вл б ®зҐаҐ¤п¬Ё.');
    Writeln('‚лЎҐаЁвҐ ¦Ґ«*Ґ¬®Ґ ¤Ґ©бвўЁп:');
    Writeln('1) „®Ў*ўЁвм н«Ґ¬Ґ*в.');
    Writeln('2) ‚лў®¤ ®зҐаҐ¤Ё (**зЁ**п б Ј®«®ўл).');
    Writeln('3) “¤*«Ґ*ЁҐ н«Ґ¬Ґ*в* Ї® §**зҐ*Ёо.');
    Writeln('4) “¤*«Ґ*ЁҐ н«Ґ¬Ґ*в* Ї® Ї®ап¤Є®ў®¬г *®¬Ґаг.');
    Writeln('5) Џ®ЁбЄ н«Ґ¬Ґ*в* Ї® §**зҐ*Ёо.');
    Writeln('6) ‘®авЁа®ўЄ* ®зҐаҐ¤Ё ¬Ґв®¤®¬ "Џг§ламЄ*", ¬Ґ*пп в®«мЄ® ¤***лҐ.');
    Writeln('7) ‘®авЁа®ўЄ* ®зҐаҐ¤Ё ¬Ґв®¤®¬ "Џг§ламЄ*", ¬Ґ*пп в®«мЄ® *¤аҐб*.');
    Writeln('8) ‚ле®¤.');
    writeln;
    ...
    case ch of {выбираем клавишу}
      ...
      '5':begin
            ...
            if tmpl=nil then {проверяем найден ли элемент и выводим соответствующие сообщения}
              write('?бЄ®¬л© н«Ґ¬Ґ*в ®вбгвбвўгҐв ў ®зҐаҐ¤Ё')
            else
